(function () {
  ...
  ═══════════════════════════════════════════════ */
  var DETAILS = {
    'T101': { desc: '일반보병은 보병의 핵심 전투원으로 K2 소총 등 개인화기를 운용하며 지상전투 최전선에서 임무를 수행합니다. 간부는 분대장·소대장으로 병사를 직접 지휘합니다.', duties: ['분대 지휘 및 전투통제', '소총·기관총 운용', '야간·산악·시가지 전투', '전투훈련 기획·지도'], pros: '강인한 전투 리더십, 높은 자부심', cons: '체력 요구 수준이 매우 높음', youtube: 'https://www.youtube.com/results?search_query=육군+일반보병', ytTitle: '일반보병 훈련 영상', match: 88 },
  ...
  function recommend(p) {
    ...
    var MAJOR_MAP = {
      ...
      '소프트웨어·AI': [['T703', 90, '소프트웨어·AI 전공 직결'], ['T502', 45, '데이터 분석 연관'], ['T506', 40, '무인기 체계 연관']],
      '정보보안': [['T703', 95, '사이버·보안 전공 직결'], ['T504', 60, '방첩 연관']],
      '화학·화공': [['K101', 85, '화학·화공 전공 직결'], ['K402', 30, '이공계 연관']],
      '신소재·나노': [['K403', 55, '정밀 무기 연관'], ['K101', 50, '화학 연관'], ['K405', 40, '광학 연관']],
      ...
      '로봇·메카트로닉스': [['K403', 70, '정밀기계·전자기계 전공'], ['K406', 55, '기계 장비 전공'], ['T703', 45, '무인 체계 연관'], ['T506', 40, '드론 연관']],

      '생물·의생명': [['K101', 60, '생물·화학 전공'], ['S101', 40, '의생명 연관']],
      '물리·수학': [['T303', 55, '이공계·물리 전공'], ['T502', 45, '이공계 전공'], ['K403', 40, '이공계 전공'], ['T701', 25, '통신 연관']],
      '환경·지구과학': [['K101', 55, '환경 보호 연관'], ['T303', 40, '기상 측정 연관'], ['T602', 30, '자연 인프라 연관']],

      '경영·경제': [['A301', 75, '경영·경제 전공 직결'], ['K201', 55, '물류·경영 전공'], ['K413', 40, '물류·경영 전공'], ['K302', 25, '이동관리 연관']],
      '무역·경영': [['K201', 60, '국제물류 연관'], ['K303', 55, '항만운용 연관'], ['A301', 50, '상경계 연관']],
      '행정·법학': [['S201', 75, '법학 전공 직결'], ['A202', 65, '법학·수사 전공'], ['A101', 50, '행정 전공']],
      '경찰행정·범죄학': [['A201', 80, '경찰행정 전공 직결'], ['A202', 75, '범죄수사 전공 직결'], ['T504', 40, '조사 연관']],
      '사회복지': [['S301', 70, '사회복지 전공 직결'], ['A401', 45, '교육·복지 전공'], ['A101', 25, '인사/행정 연관']],
      '심리학': [['S301', 65, '심리·상담 전공'], ['A401', 50, '교육·심리 전공'], ['A101', 25, '인사/상담 연관']],
      ...
      '의학·간호': [['S101', 90, '의료·간호 전공 직결']],
      '응급구조': [['S101', 90, '응급구조 전공 직결']],
      '약학·보건·재활': [['S101', 85, '보건·의약 전공 직결'], ['K101', 20, '약품 취급 연관']],

      '물류·유통': [['K201', 70, '물류·유통 전공 직결'], ['A301', 50, '상경계 전공'], ['K413', 40, '수리부속 관리 연관'], ['K302', 25, '이동관리 연관']],
